...
/*
 * Eflags/ftop registers:
 *     eflags: 32 bit
 *     ftop: 32 bit
 */
#define DBG_EFLAGS		(DBG_SCR_END + 1)
#define DBG_FTOP		(DBG_EFLAGS + 1)

#define DBG_MAX_REG_NUM		(DBG_FTOP + 1)
 ...
 */
#define NUMREGBYTES		((DBG_PT_REGS_NUM + DBG_FPR_NUM + DBG_SCR_NUM) * \
				sizeof(GDB_SIZEOF_REG) + DBG_FCC_NUM * 1 + DBG_FCSR_NUM * 4 + 8)
